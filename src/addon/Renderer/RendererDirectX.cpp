...
CRendererClientDirectX::CRendererClientDirectX(CWebBrowserClient* client) :
  m_client(client),
  m_initialized(false),
  m_textureId(0),
  m_viewWidth(0),
...
void CRendererClientDirectX::Cleanup()
{
...
bool CRendererClientDirectX::Dirty2()
{
  if (!m_initialized)
    Initialize();
...
bool CRendererClientDirectX::GetViewRect(CefRefPtr<CefBrowser> browser, CefRect& rect)
{
...
bool CRendererClientDirectX::GetScreenPoint(CefRefPtr<CefBrowser> browser, int viewX, int viewY, int& screenX, int& screenY)
{
  CEF_REQUIRE_UI_THREAD();
...
void CRendererClientDirectX::OnPaint(CefRefPtr<CefBrowser> browser, PaintElementType type,
