...
class CWebBrowserClientOpenGLES :
  public CWebBrowserClientBase,
  public CefRenderHandler
{
public:
  CWebBrowserClientOpenGLES(int iUniqueClientId, const WEB_ADDON_GUI_PROPS *props, CWebBrowser* instance);
