...
if(CEF_COMPLETE)
  ...
  set(CEF_BRANCH_URL https://bitbucket.org/kodi-web/cef.git)
  add_revision(cef-binary)
else()
  # CEF_OS_NAME and BITSIZE are defined by CMakeLists.txt
  add_revision(cef-binary
    URL https://bitbucket.org/kodi-web/cef/downloads/kodi-web-${CEF_OWN_CHANGES_VERSION}_cef_binary_3_${CEF_COMPLETE_VERSION}_${CEF_OS_NAME}${BITSIZE}.zip
